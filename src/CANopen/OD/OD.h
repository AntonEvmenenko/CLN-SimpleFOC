...
typedef struct {
    ...
    float32_t x6064_positionActualValue;
    float32_t x607A_targetPosition;
} OD_RAM_t;
...
#define OD_ENTRY_H6064 &OD->list[21]
#define OD_ENTRY_H607A &OD->list[22]
...
#define OD_ENTRY_H6064_positionActualValue &OD->list[21]
#define OD_ENTRY_H607A_targetPosition &OD->list[22]
