This branch is a WIP and is not intended for use by anyone other than the author. The code in this branch is intended to run on modified hardware, it's unstable, and may not be entirely safe.
